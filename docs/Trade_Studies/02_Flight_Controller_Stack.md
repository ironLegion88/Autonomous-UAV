# Trade Study 02: Flight Controller Stack, Firmware, and Avionics
...
| :--- | :--- | :--- | :--- | :--- |
| **Primary Use Case** | Manual FPV / Racing | GPS FPV / Cruising | Research / Robotics | Robotics / Reliability |
...
xychart-beta
    ...
    bar [45, 10, 95]
```
*Note: The F722 chip is practically obsolete for ArduPilot due to its crippling 512KB flash limit, despite its faster clock speed.*
...
To maintain the 1.5kg AUW endurance limit on a 6-inch frame, a **30x30mm 4-in-1 Stack** (combining the FC and the ESC into a compact tower) is mandatory.
...
flowchart TD
    ...
    subgraph Flight Stack [SkyStars H7 FC]
